...
const SubscribeModal = ({ subscribe, onClose}) => {
    return (
        <div className="fixed bg-black bg-opacity-60 top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center" onClick={onClose}>
            ...
            >
                ...
                <h4 className="my-2 text-gray-500">{subscribe._id}</h4>
                <div className="flex justify-start items-center gap-x-2">
                    {/*//!React-icon <PiBookOpenTextLight className="text-red-300 text-2xl" /> */}
                    <span className="text-red-300 text-2xl">📧</span>
                    <h2 className="my-1">{subscribe.email}</h2>
                </div>
                <div className="flex justify-start items-center gap-x-2">
                    {/*//!React-icon <PiBookOpenTextLight className="text-red-300 text-2xl" /> */}
                    <span className="text-red-300 text-2xl">👤</span>
                    <h2 className="my-1">{subscribe.userName} {subscribe.password}</h2>
                </div>
