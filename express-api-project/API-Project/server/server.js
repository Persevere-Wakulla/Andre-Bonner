...
//! MIDDLEWARE ALWAYS GO BETWEEN THE APP= EXPRESS()... AND THE APP.GET('/')
//app.use(cors())
app.use(cors());
...
//     //todo: API
//     res.status(200).json({
//         "Ten in-demand Cybersecurity certifications": {
//             "Certified Information Systems Security Professional (CISSP)": {
//                 'id': 1,
//                 "level": "Advanced",
//                 "info": "The CISSP certification from the cybersecurity professional organisation (ISC)² ranks among the most sought-after credentials in the industry. Earning your CISSP demonstrates that you’re experienced in IT security and capable of designing, implementing, and monitoring a cybersecurity programmer.",
//                 "roles": ['Chief information security officer', 'Security administrator', 'IT security engineer', 'Senior security consultant'],
//                 "requirments": "Requirements to qualify for the CISSP exam: You’ll need a four-year degree in computer science to satisfy one year of the work requirement. Part-time work and paid internships also count. You’ll also need five or more years of cumulative work experience in at least two of eight cybersecurity domains.",
//                 "cybersecurityDomains": ["Security and risk management", "Asset security", "Security architecture and engineering", "Communication and network security", "Identity and access management", "Security assessment and testing", "Security operations", "Software development security"],
//                 "cost": '₹61,409 ($749 USD)',
//                 "altPath": "(Path to CISSP)- If you're new to cybersecurity and lack the necessary experience, you can still take the exam to become an Associate of (ISC)2. Once you pass the exam, you'll then have six years to build the relevant experience for full CISSP certification."
//             },
//             "Certified Information Systems Auditor (CISA)": {
//                 'id': 2,
//                 "level": "mid-level",
//                 "info": "This credential from IT professional association ISACA helps demonstrate your expertise in assessing security vulnerabilities, designing and implementing controls, and reporting on compliance. It’s among the most recognised certifications for careers in cybersecurity auditing.",
//                 "roles": ['IT audit manager', 'Information security analyst', 'IT security engineer', 'IT project manager', 'Compliance programme manager'],
//                 "requirments": "You need at least five years of experience in IT or IS audit, control, security, or assurance. A degree can be substituted for years of experience.",
//                 "cybersecurityDomains": ["Security and risk management", "Asset security", "Security architecture and engineering", "Communication and network security", "Identity and access management", "Security assessment and testing", "Security operations", "Software development security"],
